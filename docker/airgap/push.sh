...
# Usage: ./docker/airgap/push.sh {ui|collector}
#
# Run ./docker/airgap/build.sh cluster <app> first — this only tags and pushes.
...
#
# Override the registry base with: REGISTRY=<host>/<namespace> ./docker/airgap/push.sh <app>
#
